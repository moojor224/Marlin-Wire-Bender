...
this repository is a fork of the marlin firmware for 3d printers, with configs made for the SKR V1.4 board, designed to be used as a cnc wire bending machine. See the main repository at [moojor224/cnc-wire-bender](https://github.com/moojor224/cnc-wire-bender/) for more info
